...
function Args() {
    ...
    process.argv.slice(2).forEach(function (arg) {
        ...
        // help info
            ...
            console.log(usageInfo.info);
            process.exit(0);
        } else {
            console.error(('Unknown argument "'+ arg +'".').error);
            console.log(usageInfo.info);
            process.exit(1);
        }
    });
...
function emptyArgValue(argName) {
    console.error(('Empty "--'+ argName +'=" argument value.').error);
    console.log(usageInfo.info);
    process.exit(1);
}
...
function incorrectArgValue(argName) {
    console.error(('Incorrect "--'+ argName +'=" argument value.').error);
    console.log(usageInfo.info);
    process.exit(1);
}
